    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-white flex flex-col">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 py-32 text-center">
          ...
          >
            QVT Box propose une expérience phygitale inédite : une box mensuelle
            100% française associée à une application IA éthique, pour prévenir
            le stress au travail comme à la maison.
          </motion.p>
        </div>
      </section>
            ...
            {[
              {
                ...
                desc: "Choix du segment et création du compte.",
              },
              {
                step: "2",
                title: "Diagnostic instantané",
                desc: "Questionnaire express et première évaluation.",
              },
              {
                step: "3",
                title: "Réception de la Box",
                desc: "Livraison mensuelle de vos outils.",
              },
              {
                step: "4",
                title: "Suivi & Coaching",
                desc: "Suivi quotidien et recommandations personnalisées.",
              },
            ].map((s, i) => (
              <motion.div
                key={i}
      ...
      <section className="container mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {[
            {
              quote: "Nous avons réduit l’absentéisme de 30% en 6 mois.",
              author: "Marie, DRH PME",
            },
            {
              quote: "Un vrai lien recréé avec ma fille.",
              author: "Julien, parent",
            },
          ].map((t, i) => (
            <motion.blockquote
              key={i}
      ...
      <section className="bg-blue-50 py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          >
            Rejoignez-nous et intégrez des rituels bien-être concrets, à la
