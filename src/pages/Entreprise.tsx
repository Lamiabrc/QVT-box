...
import { BarChart3, FileText, Lightbulb, Package, ArrowLeft, Users, TrendingUp } from "lucide-react";
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          <Card className="group hover:shadow-lg transition-all duration-300 cursor-pointer transform hover:-translate-y-1"
            ...
            <CardHeader className="text-center pb-4">
              ...
              <CardTitle className="text-lg">Questionnaire QVT</CardTitle>
            </CardHeader>
            <CardContent className="text-center pt-0">
              <p className="text-muted-foreground text-sm mb-4">
                Formulaire dynamique avec scoring IA automatique.
              </p>
              <Button className="w-full" variant="outline">
          ...
          <Card className="group hover:shadow-lg transition-all duration-300 cursor-pointer transform hover:-translate-y-1"
            ...
            <CardHeader className="text-center pb-4">
              ...
              <CardTitle className="text-lg">Historique Box</CardTitle>
            </CardHeader>
            <CardContent className="text-center pt-0">
              <p className="text-muted-foreground text-sm mb-4">
                Suivi des envois et feedback des équipes.
              </p>
              <Button className="w-full" variant="outline">
