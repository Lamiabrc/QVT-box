...
const TeensDashboardParent = () => {
  ...
  const [notifications, setNotifications] = useState([
    {
      id: 1,
      type: "alert",
      message: "Alex a envoyé une alerte 'En soirée'",
      time: "Il y a 15 min",
      urgent: false
    },
    {
      id: 2,
      type: "mood",
      message: "Mood d'Alex: Plutôt stressé 😰",
      time: "Il y a 1h",
      urgent: true
    },
    {
      id: 3,
      type: "checkin",
      message: "Check-in quotidien d'Alex terminé",
      time: "Il y a 2h",
      urgent: false
    }
  ]);
  ...
  const weeklyStats = {
    "Alex": { mood: 7.5, activities: 12, alerts: 2 }
  };
                  ...
                  <div className="bg-white p-4 rounded-xl border-2 border-gray-300">
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-center gap-2">
                        ...
                        <span>Alex (17 ans) - En ligne</span>
                      </li>
                    </ul>
                  </div>
