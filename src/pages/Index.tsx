...
import { Building2, Users, Shield, Brain, Heart, Package, ArrowRight, CheckCircle, Target, Coffee, Star, Gift, Zap, Smile, TrendingUp, Calendar, Headphones, Camera, Gamepad2, Book, Music, Palette, Award, Clock, Sun, Moon } from 'lucide-react';
...
const Index = () => {
  ...
  // Grandes bulles pour les univers avec z-index très élevé
        ...
        <section className="container mx-auto px-4 py-16">
          ...
          <div className="text-center mb-16 relative overflow-hidden min-h-[700px]">
            ...
            <div className="absolute inset-0 w-full h-full overflow-hidden z-10">
              ...
              {/* Grandes bulles des univers avec z-index très élevé */}
              {universeBubbles.map(universe => (
                <div 
                  key={universe.id} 
                  className={`absolute ${universe.position} cursor-pointer group z-50`} 
                  onClick={() => handleBubbleClick(universe.route)}
                >
                  <div className="relative transform transition-all duration-1000 group-hover:scale-110 group-hover:rotate-3">
                    <div className={`w-56 h-56 bg-gradient-to-br ${universe.bgGradient} rounded-full shadow-2xl flex flex-col items-center justify-center group-hover:shadow-3xl transition-all duration-700 border-4 border-white/70 group-hover:border-white/90 relative overflow-hidden backdrop-blur-sm`}>
                      ...
                      <h3 className="text-2xl font-bold text-gray-800 mb-2 relative z-10">{universe.title}</h3>
                      <p className="text-sm text-gray-600 relative z-10 text-center">{universe.subtitle}</p>
                      <p className="text-xs text-gray-500 mt-1 relative z-10 text-center">{universe.description}</p>
                    </div>
                    
                    <div className="absolute -top-3 -right-3 w-14 h-14 bg-gradient-to-br from-green-400 to-emerald-500 rounded-full flex items-center justify-center animate-bounce shadow-lg">
            ...
            <div className="relative z-20">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 max-w-4xl mx-auto shadow-xl border border-white/50 relative z-20">
                ...
                <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed">
                  ...
                  au travail ou en famille. <strong>Cliquez sur les bulles pour choisir votre univers !</strong>
                </p>
