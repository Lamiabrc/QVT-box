...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50 relative overflow-hidden">
      {/* Crystal floating elements with red accents */}
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute top-40 right-20 w-24 h-24 bg-gradient-to-br from-red-200/40 to-pink-200/40 rounded-full animate-bounce shadow-xl"></div>
        ...
        <div className="absolute bottom-40 right-10 w-20 h-20 bg-gradient-to-br from-red-100/50 to-primary/40 rounded-full animate-pulse shadow-xl"></div>
      ...
      {/* Pure crystal particles with red accents */}
      <div className="absolute inset-0 overflow-hidden">
        {[...Array(30)].map((_, i) => (
          <div
            key={i}
            className={`absolute w-1 h-1 ${i % 8 === 0 ? 'bg-gradient-to-r from-red-300 to-pink-300' : 'bg-gradient-to-r from-blue-300 to-cyan-300'} rounded-full animate-pulse shadow-sm`}
            style={{
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="relative">
                ...
                />
                {/* Bubble animation around logo with red accent */}
                <div className="absolute -inset-2 border-2 border-red-300/30 rounded-full animate-ping"></div>
              </div>
              <div>
                <h1 className="text-3xl font-bold bg-gradient-to-r from-primary via-secondary to-red-500 bg-clip-text text-transparent">
                  QVT Box
                </h1>
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="flex items-center space-x-2 bg-gradient-to-r from-green-50 to-red-50/30 px-4 py-2 rounded-full border border-green-200/50">
      ...
      <section className="container mx-auto px-4 py-16 relative z-10">
        ...
        <div className="text-center mb-8 relative">
          <div className="relative inline-block">
            ...
            <div className="w-32 h-32 mx-auto mb-6 relative">
              ...
              <div className="absolute -inset-4 border-2 border-red-400/20 rounded-full animate-ping"></div>
              <div className="absolute -inset-8 border border-blue-300/20 rounded-full animate-pulse"></div>
            </div>
            
            {/* Speech bubble */}
            <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-2xl shadow-lg border border-red-200/30 animate-fade-in">
              <p className="text-sm font-medium text-gray-700">Bienvenue !</p>
              <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 rotate-45 w-2 h-2 bg-white border-r border-b border-red-200/30"></div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mb-16 animate-fade-in">
          <h2 className="text-5xl md:text-7xl font-black mb-8">
            <span className="bg-gradient-to-r from-primary via-secondary to-red-500 bg-clip-text text-transparent">
              L'IA au service de votre
            </span>
            <span className="block text-6xl md:text-8xl bg-gradient-to-r from-cyan-500 via-blue-600 to-red-400 bg-clip-text text-transparent drop-shadow-sm">
              Qualité de Vie
            </span>
          </h2>
          
          {/* Phygital concept highlight */}
          <div className="mb-8 p-6 bg-gradient-to-r from-white/70 via-red-50/20 to-cyan-50/70 backdrop-blur-sm rounded-3xl border border-white/50 shadow-xl max-w-4xl mx-auto">
            <div className="flex items-center justify-center space-x-3 mb-4">
              <Package className="w-8 h-8 text-primary animate-pulse" />
              <h3 className="text-2xl font-bold bg-gradient-to-r from-primary via-red-500 to-secondary bg-clip-text text-transparent">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 text-sm">
            ...
            <div className="flex items-center space-x-2 bg-white/60 backdrop-blur-sm px-6 py-3 rounded-2xl border border-red-200/50 shadow-lg">
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          {/* Entreprise Card */}
          <Card className="group hover:shadow-2xl transition-all duration-500 border-2 border-primary/30 hover:border-red-400/60 cursor-pointer transform hover:-translate-y-6 bg-gradient-to-br from-white/80 to-primary/5 backdrop-blur-sm"
                onClick={() => navigate('/auth')}>
            <CardContent className="p-8">
              <div className="text-center">
                <div className="w-24 h-24 bg-gradient-to-br from-primary/20 to-red-200/30 rounded-3xl mx-auto mb-6 flex items-center justify-center group-hover:scale-110 transition-all duration-300 shadow-lg border border-primary/20">
                  <Building2 className="w-12 h-12 text-primary group-hover:animate-pulse" />
                </div>
                <h3 className="text-3xl font-bold bg-gradient-to-r from-primary via-red-500 to-secondary bg-clip-text text-transparent mb-4">
                  Espace Entreprise
                </h3>
                ...
                <Button className="w-full bg-gradient-to-r from-primary via-red-500 to-secondary hover:from-primary/90 hover:to-red-500/90 text-white rounded-2xl py-6 text-lg font-semibold transform transition-all duration-300 hover:scale-105 shadow-lg">
          ...
          {/* Famille Card */}
          <Card className="group hover:shadow-2xl transition-all duration-500 border-2 border-secondary/30 hover:border-red-400/60 cursor-pointer transform hover:-translate-y-6 bg-gradient-to-br from-white/80 to-secondary/5 backdrop-blur-sm"
                onClick={() => navigate('/auth')}>
            <CardContent className="p-8">
              <div className="text-center">
                <div className="w-24 h-24 bg-gradient-to-br from-secondary/20 to-red-200/30 rounded-3xl mx-auto mb-6 flex items-center justify-center group-hover:scale-110 transition-all duration-300 shadow-lg border border-secondary/20">
                  <Users className="w-12 h-12 text-secondary group-hover:animate-pulse" />
                </div>
                <h3 className="text-3xl font-bold bg-gradient-to-r from-secondary via-red-500 to-accent bg-clip-text text-transparent mb-4">
                  Espace Famille
                </h3>
                <p className="text-gray-600 mb-6 text-lg leading-relaxed">
                ...
                <Button className="w-full bg-gradient-to-r from-secondary via-red-400 to-accent hover:from-secondary/90 hover:to-red-400/90 text-white rounded-2xl py-6 text-lg font-semibold transform transition-all duration-300 hover:scale-105 shadow-lg">
        ...
        <div className="mt-24 text-center">
          <h3 className="text-3xl font-bold bg-gradient-to-r from-primary via-red-500 to-accent bg-clip-text text-transparent mb-12 animate-fade-in">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="space-y-4 bg-white/70 backdrop-blur-sm p-8 rounded-3xl border border-white/50 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="w-20 h-20 bg-gradient-to-br from-primary/20 to-red-200/30 rounded-3xl mx-auto flex items-center justify-center shadow-lg">
                <Shield className="w-10 h-10 text-primary animate-pulse" />
              </div>
              <h4 className="text-xl font-semibold text-gray-700">Sécurité & Confidentialité</h4>
              <p className="text-gray-600 leading-relaxed">Données hébergées en France, RGPD compliant, consentement parental sécurisé.</p>
            </div>
            <div className="space-y-4 bg-white/70 backdrop-blur-sm p-8 rounded-3xl border border-white/50 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="w-20 h-20 bg-gradient-to-br from-secondary/20 to-red-200/30 rounded-3xl mx-auto flex items-center justify-center shadow-lg">
            ...
            <div className="space-y-4 bg-white/70 backdrop-blur-sm p-8 rounded-3xl border border-white/50 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="w-20 h-20 bg-gradient-to-br from-accent/20 to-red-200/30 rounded-3xl mx-auto flex items-center justify-center shadow-lg">
                <Heart className="w-10 h-10 text-red-400 animate-pulse" />
              </div>
              <h4 className="text-xl font-semibold text-gray-700">Approche Bienveillante</h4>
