...
const Header = () => {
  ...
  return <motion.header initial={{
    ...
    ease: "easeOut"
        ...
        <div className="flex items-center justify-between">
            ...
            <Link to="/" className="flex items-center space-x-4 group">
              <div className="relative">
                ...
                ease: "easeInOut"
                  ...
                  <img src="/images/logo-qvt.png" alt="QVT Box Logo" className="w-12 h-12 object-contain rounded-full group-hover:scale-110 transition-transform duration-300" />
              ...
              <div className="group-hover:translate-x-1 transition-transform duration-300">
                <motion.h1 className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-teal-600" whileHover={{
                scale: 1.02
              }}>
                  QVT Box
                </motion.h1>
                <motion.p className="text-sm text-slate-600 font-medium" initial={{
                opacity: 0
              }} animate={{
                opacity: 1
              }} transition={{
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            scale: 0.95
              ...
              <Link to="/concept-qvt" className="group flex items-center space-x-2 text-slate-700 hover:text-purple-600 transition-all duration-300">
                ...
                <span className="font-semibold group-hover:underline decoration-purple-500 decoration-2 underline-offset-4">✨ Concept QV</span>
              </Link>
            </motion.div>
          </nav>
          ...
          <div className="flex items-center space-x-4">
            {user ? <div className="flex items-center space-x-4">
                {isSuperAdmin && <motion.div whileHover={{
              scale: 1.05
            }} whileTap={{
              scale: 0.95
            }}>
                ...
                {isAdmin && !isSuperAdmin && <motion.div whileHover={{
              scale: 1.05
            }} whileTap={{
              scale: 0.95
            }}>
      ...
      <motion.div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-blue-500 via-purple-500 to-teal-500" initial={{
      scaleX: 0
    }} animate={{
      scaleX: 1
    }} transition={{
