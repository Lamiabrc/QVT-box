        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            >
              <Link 
                to="/entreprise" 
                className="group flex items-center space-x-2 text-slate-700 hover:text-blue-600 transition-all duration-300 relative"
              >
                <div className="relative">
            ...
            >
              <Link 
                to="/famille" 
                className="group flex items-center space-x-2 text-slate-700 hover:text-teal-600 transition-all duration-300 relative"
              >
                <div className="relative">
            ...
            >
              <Link 
                to="/concept-qvt" 
                className="group flex items-center space-x-2 text-slate-700 hover:text-purple-600 transition-all duration-300"
              >
                <Sparkles className="h-5 w-5 group-hover:rotate-12 transition-transform duration-300" />
                <span className="font-semibold group-hover:underline decoration-purple-500 decoration-2 underline-offset-4">
                  ✨ Concept QVT
                </span>
              </Link>
            </motion.div>
              ...
              <div className="flex items-center space-x-4">
                  ...
                  >
                    <Link to="/admin">
                      <Button 
                        variant="outline" 
                        size="sm" 
                        className="bg-gradient-to-r from-purple-50 to-pink-50 text-purple-700 border-purple-200 hover:bg-gradient-to-r hover:from-purple-100 hover:to-pink-100 shadow-md"
                      >
                ...
                >
                  <Button 
                    ...
                    className="flex items-center space-x-2 hover:bg-red-50 hover:text-red-600 transition-all duration-300"
                  >
                ...
                >
                  <Link to="/auth">
                    <Button 
                      variant="outline" 
                      size="sm"
                      className="hover:bg-blue-50 hover:border-blue-300 transition-all duration-300 shadow-md"
                    >
